...
<td>
<a class='bn btn-primary' href='?classe=Projeto&acao=read&id=<?=$projeto->id?>'>Ver</a>
<a class='bn btn-primary' href='?classe=Projeto&acao=update&id=<?=$projeto->id?>'>Alterar</a>
